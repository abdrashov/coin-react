...
const ExpenseCategory = () => {
    ...
    const store = async () => {
        await API
            .post(`/api/category/expense`, form)
    ...
    useEffect(() => {
        API.get(`api/category/expense`)
            .then(resp => {
                setCategories(resp.data.expenses)
            })
    }, [setCategories])
    ...
    return (
        <div>
            ...
            <button
                ...
                className="mt-3 mb-5 flex items-center justify-between w-full p-2 md:hover:bg-teal-100 active:bg-teal-100 duration-200">
