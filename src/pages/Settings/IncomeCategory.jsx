...
const IncomeCategory = () => {
    ...
    useEffect(() => {
        API.get(`api/category/income`)
            .then(resp => {
                setCategories(resp.data.incomes)
            })
    }, [setCategories])
    ...
    return (
        <div>
            ...
            <button
                ...
                className="mt-3 mb-5 flex items-center justify-between w-full p-2 md:hover:bg-yellow-100 active:bg-yellow-100 duration-200">
                <div className="flex items-center">
                    <div className="w-7 h-7 bg-yellow-400 text-gray-50 text-tiny rounded-md flex items-center justify-center">
                        <FontAwesomeIcon icon="fa-solid fa-plus" />
                    </div>
